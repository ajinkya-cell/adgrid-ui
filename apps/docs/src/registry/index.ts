...
export const registry: RegistryEntry[] = [
  ...
  },
  {
    ...
    slug: "roughly",
    category: "animated",
    description: "Organic, hand-drawn vector annotations designed for high-friction digital typography. Wobbly underlines, pen circles, editorial strikethroughs, curly brackets, and tactile highlights.",
    dependencies: ["framer-motion", "roughjs"],
    packagePath: "animated/Roughly.tsx",
    files: [
      "animated/Roughly.tsx",
      "animated/roughly/index.ts",
      "animated/roughly/RoughArrow.tsx",
      "animated/roughly/RoughBox.tsx",
      "animated/roughly/RoughBracket.tsx",
      "animated/roughly/RoughCircle.tsx",
      "animated/roughly/RoughCross.tsx",
  ...
  },
  {
    ...
    category: "backgrounds",
    description: "An atmospheric sweeping pattern background with breathing backlight glow, vignette layer, and dynamic pattern options (diagonal, stripes, dots, grid).",
    dependencies: ["framer-motion"],
    packagePath: "backgrounds/BreathingBackground.tsx",
    files: ["backgrounds/BreathingBackground.tsx"],
    presentationStrategy: "fullscreen",
    propDefs: [
      { name: "preset", type: "select", default: "indigo", description: "Curated color theme preset", required: false, options: ["indigo", "cyberpunk", "emerald", "amber", "custom"] },
      { name: "patternVariant", type: "select", default: "diagonal", description: "Geometric pattern background variant", required: false, options: ["diagonal", "stripes", "dots", "grid"] },
      { name: "duration", type: "number", default: 8, description: "Breathing loop speed in seconds", required: false, min: 2, max: 20, step: 1 },
      { name: "patternSize", type: "number", default: 16, description: "Pattern tile size in pixels", required: false, min: 6, max: 48, step: 2 },
      { name: "angle", type: "number", default: 315, description: "Gradient pattern angle in degrees", required: false, min: 0, max: 360, step: 15 },
      { name: "vignette", type: "boolean", default: true, description: "Enable soft edge and corner vignette mask", required: false },
    ],
  },
  {
  ...
  {
    name: "Breathing Scale Card",
    slug: "breathing-scale-card",
    category: "animated",
    description: "An ambient scale card component featuring overshooting corner border lines, a soft vignette mask, breathing backlight glows, and sweeping geometric pattern animations.",
    dependencies: ["framer-motion"],
    packagePath: "animated/BreathingScaleCard.tsx",
    files: ["animated/BreathingScaleCard.tsx"],
    presentationStrategy: "center",
    propDefs: [
      { name: "preset", type: "select", default: "indigo", description: "Curated color theme preset", required: false, options: ["indigo", "cyberpunk", "emerald", "amber", "custom"] },
      { name: "patternVariant", type: "select", default: "diagonal", description: "Geometric pattern background variant", required: false, options: ["diagonal", "stripes", "dots", "grid"] },
      { name: "duration", type: "number", default: 7, description: "Breathing loop speed in seconds", required: false, min: 2, max: 20, step: 1 },
      { name: "patternSize", type: "number", default: 10, description: "Pattern tile size in pixels", required: false, min: 4, max: 40, step: 2 },
      { name: "vignette", type: "boolean", default: true, description: "Enable soft edge and corner vignette mask", required: false },
    ],
  },
  {
    ...
    slug: "github-heatmap",
    category: "animated",
    description: "An ultra-polished GitHub contribution heatmap featuring live data fetching for @ajinkya-cell, streak stats, theme presets, interactive tooltips, and month focus filtering.",
    dependencies: ["framer-motion"],
    packagePath: "animated/GithubHeatmap.tsx",
    files: ["animated/GithubHeatmap.tsx"],
    presentationStrategy: "center",
    propDefs: [
      { name: "username", type: "string", default: "ajinkya-cell", description: "GitHub username to fetch contributions for", required: false },
      { name: "preset", type: "select", default: "emerald", description: "Color theme preset", required: false, options: ["emerald", "obsidian", "cyberpunk", "indigo", "custom"] },
      { name: "showStats", type: "boolean", default: true, description: "Display total contributions, streak, and peak day stats", required: false },
      { name: "showLegend", type: "boolean", default: true, description: "Display bottom contribution scale legend", required: false },
      { name: "showMonthLabels", type: "boolean", default: true, description: "Display clickable month headers", required: false },
      { name: "showDayLabels", type: "boolean", default: true, description: "Display day of week labels", required: false },
    ],
  },
  {
    ...
    category: "animated",
    description: "An ultra-polished, feature-packed 3D Developer ID Card featuring GitHub profile image, live local clock, tech stack badges, social links, and 3D metallic presets.",
    dependencies: ["framer-motion"],
    packagePath: "animated/DeveloperIdCard.tsx",
    files: ["animated/DeveloperIdCard.tsx"],
    presentationStrategy: "center",
    propDefs: [
      { name: "name", type: "string", default: "Ajinkya", description: "Display name", required: false },
      { name: "username", type: "string", default: "ajinkya-cell", description: "GitHub handle", required: false },
      { name: "role", type: "string", default: "Full-Stack Engineer & UI Architect", description: "Developer title or role", required: false },
      { name: "location", type: "string", default: "San Francisco, CA", description: "Location text", required: false },
      { name: "bio", type: "string", default: "Architecting high-performance UI systems, agentic coding workflows, and futuristic web interfaces.", description: "Custom intro bio text", required: false },
      { name: "preset", type: "select", default: "obsidian-gold", description: "3D theme finish preset", required: false, options: ["obsidian-gold", "monochrome-titanium", "cyberpunk-neon", "emerald-matrix", "midnight-amethyst"] },
      { name: "statusBadge", type: "string", default: "AVAILABLE FOR HIRE", description: "Availability pill text", required: false },
      { name: "showClock", type: "boolean", default: true, description: "Display live local time & timezone", required: false },
  ...
  },
  {
    ...
    slug: "switch",
    category: "animated",
    description: "Mechanical 3D rocker switch with realistic light/shadow elevation flips, integrated glowing LED indicator dot, and rebound spring physics.",
    dependencies: ["framer-motion"],
    packagePath: "animated/Switch.tsx",
    files: ["animated/Switch.tsx"],
    presentationStrategy: "center",
    propDefs: [
      { name: "checked", type: "boolean", default: true, description: "Controlled switch toggle state", required: false },
      { name: "disabled", type: "boolean", default: false, description: "Disable switch interaction", required: false },
      { name: "size", type: "select", default: "md", description: "Switch size variant", required: false, options: ["sm", "md", "lg"] },
      { name: "label", type: "string", default: "Security Protocol", description: "Switch label text", required: false },
      { name: "description", type: "string", default: "Enable 2FA Hardware Shield", description: "Switch description subtext", required: false },
    ],
  },
  {
    name: "OTP Component",
    slug: "otp-input",
    category: "animated",
    description: "Laser Vault PIN keypad and cell array featuring debossed input sockets, digit slot entry flash, red laser error shake, and green success unlock reveal.",
    dependencies: ["framer-motion", "lucide-react"],
  ...
  },
  {
    ...
    slug: "tooltip",
    category: "animated",
    description: "Magnetic Hologram Tooltip featuring 3D parallax tracking with mouse cursor position, glowing neon border, and frosted glass backdrop blur.",
    dependencies: ["framer-motion"],
  ...
  },
  {
    ...
    slug: "stepper",
    category: "animated",
    description: "Circuit Path Stepper featuring traveling laser light pulses along connecting circuit lines and illuminated 3D debossed milestone node checkpoints.",
    dependencies: ["framer-motion", "lucide-react"],
    packagePath: "animated/Stepper.tsx",
  ...
  },
  {
    ...
    slug: "timeline",
    category: "animated",
    description: "Circuit Path Timeline featuring traveling laser light pulses along connecting circuit lines and illuminated 3D debossed milestone node checkpoints.",
    dependencies: ["framer-motion", "lucide-react"],
    packagePath: "animated/Stepper.tsx",
    files: ["animated/Stepper.tsx"],
    presentationStrategy: "center",
