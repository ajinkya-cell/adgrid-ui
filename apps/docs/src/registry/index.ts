...
export const registry: RegistryEntry[] = [
  ...
  },
  {
    ...
    category: "animated",
    description: "A canvas-based flickering contribution-graph grid, highly performant and scalable.",
    dependencies: [],
  ...
  },
  {
    ...
    slug: "dot-pattern",
    category: "animated",
    description: "A highly customizable SVG-based background pattern component.",
    dependencies: [],
