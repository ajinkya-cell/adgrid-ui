...
export const registry: RegistryEntry[] = [
  ...
  },
  {
    ...
    propDefs: [
      ...
      { name: "names", type: "string[]", default: ["Alexander", "Charlotte", "Daniel", "Emma", "James", "Lucas", "Olivia", "Sophia", "Benjamin", "Mia", "Ethan", "Amelia", "Henry", "Harper", "Sebastian", "Evelyn", "Jack", "Aria", "Owen", "Ella", "Levi", "Avery", "Jackson", "Scarlett", "Mateo", "Grace", "Liam", "Ava", "Noah", "Isabella", "Oliver", "Sophia", "Elijah", "Charlotte", "William", "Amelia", "James", "Mia", "Benjamin", "Harper", "Lucas", "Evelyn", "Henry", "Abigail", "Alexander", "Emily", "Mason", "Elizabeth", "Michael", "Mila", "Ethan", "Ella", "Daniel", "Avery", "Jacob", "Sofia", "Logan", "Camila", "Jackson", "Aria", "Levi", "Scarlett", "Sebastian", "Victoria", "Jack", "Madison", "Owen", "Luna", "Theodore", "Grace", "Aiden", "Chloe", "Samuel", "Penelope", "Joseph", "Layla", "John", "Riley", "David", "Zoey", "Wyatt", "Nora", "Carter", "Lily", "Julian", "Eleanor", "Luke", "Hannah", "Grayson", "Lillian", "Jaxon", "Addison", "Asher", "Aubrey", "Gabriel", "Ellie", "Julian", "Stella", "Leo", "Natalie", "Lincoln", "Zoe", "Hudson", "Leah", "Dylan", "Hazel", "Ezra", "Violet", "Thomas", "Aurora", "Charles", "Savannah", "Christopher", "Audrey", "Miles", "Brooklyn", "Matthew", "Bella", "Josiah", "Claire", "Connor", "Skylar", "Eli", "Lucy", "Maverick", "Paisley", "Ryan", "Everly", "Nathan", "Anna", "Isaac", "Caroline", "Christian", "Nova", "Aaron", "Genesis", "Colton", "Emilia", "Roman", "Kennedy", "Hunter", "Samantha", "Eli", "Maya", "Landon", "Willow", "Brooks", "Adeline", "Cameron", "Ruby", "Adrian", "Elena", "Jonathan", "Lola", "Gavin", "Pippa", "Nolan", "Stella", "Nicholas", "Clara", "Dominic", "Alice"], description: "Input name array to lay out", required: true },
    ]
  },
  {
    name: "Hero Landing",
