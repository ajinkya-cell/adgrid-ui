...
const wheelItems = [
  {
    ...
    subItems: [
      { id: "neovim", name: "NeoVim Editor", icon: "neovim", category: "CLI", description: "Direct shell interface with command history." },
      { id: "vscode", name: "VS Code IDE", icon: "vscode", category: "Diagnostics", description: "Real-time system performance monitoring." },
    ],
  },
  {
    id: "ui",
    ...
    subItems: [
      { id: "react", name: "React Library", icon: "react", category: "Layout", description: "Declarative component-driven UI engine." },
      { id: "nextjs", name: "Next.js Framework", icon: "nextjs", category: "Display", description: "Production server rendering & routing." },
    ],
  },
  {
    id: "data",
    ...
    subItems: [
      { id: "redis", name: "Redis Cache", icon: "redis", category: "Memory", description: "High-speed in-memory key-value cache." },
      { id: "postgres", name: "PostgreSQL", icon: "postgres", category: "Persist", description: "Persistent structured ACID database." },
    ],
  },
  {
    id: "deploy",
    ...
    subItems: [
      { id: "docker", name: "Docker Containers", icon: "docker", category: "Runtime", description: "Isolated container runtime environment." },
      { id: "github", name: "GitHub Actions", icon: "github", category: "CI/CD", description: "Automated build and deployment pipeline." },
    ],
  },
];
